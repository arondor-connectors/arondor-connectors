package com.arondor.viewer.sample;
...
public class CustomAnnotationAccessor extends XFDFAnnotationAccessor
{
	private static final Logger LOGGER = Logger.getLogger(CustomAnnotationAccessor.class);
    ...
    public synchronized List<Annotation> get() throws AnnotationsNotSupportedException, InvalidAnnotationFormatException
    {
        ...
        for (Annotation annotation : annotations)
        {
            if (!isOwner(annotation, user) && !isAdmin)
            {
                ...
                annotation.setFlags(annotation.getFlags() == null ? annotation.getFlags() : new AnnotationFlags());
