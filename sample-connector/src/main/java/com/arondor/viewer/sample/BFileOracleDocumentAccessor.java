...
public class BFileOracleDocumentAccessor implements DocumentAccessor, Serializable
{
    ...
    private static final Logger LOGGER = Logger.getLogger(BFileOracleDocumentAccessor.class);
    ...
    {
        File file = new File("arender.pdf");
    ...
    public byte[] toByteArray() throws IOException
    {
        ...
        try
        {
            ...
            else
            {
                ...
                bFile.openFile();
                return bFile.getBytes(1, (int) bFile.length());
            }
        }
